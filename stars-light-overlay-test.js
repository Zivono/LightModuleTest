const MODULE_ID = "stars-light-overlay-test";
...
const textures = {
  empty: PIXI.Texture.from("modules/stars-light-overlay-test/img/LightSlotEmpty.webp"),
  full: PIXI.Texture.from("modules/stars-light-overlay-test/img/LightSlotFull.webp")
};
